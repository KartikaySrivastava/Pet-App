...
export default function Edit() {
  ...
  var index= Data.map(function(e){
    ...
    const handleSubmit = (e) => {
        ...
        let a = Data[index]; // we can access all the properties through this object

        a.petName = petName;
        a.ownerEmail = ownerEmail;
        a.ownerPhone = ownerPhone;
        a.dob = dob;
        a.gender = gender;
        a.adopted = adopted;
      ...
      useEffect(() => {
        ...
        setOwnerPhone(localStorage.getItem("ownerPhone"))
        setDob(localStorage.getItem("dob"))
        setGender(localStorage.getItem("gender"))
        setAdopted(localStorage.getItem("adopted"))
        setId(localStorage.getItem("id"))

      },[])  //Passing blank dependencies so it will run only for 1 time.
          ...
          <div>
            ...
            >
              {Array.isArray(["Male", "Female", "Non-Binary"]) ? (
                ["Select Gender","Male", "Female", "Non-Binary"].map((address, key) => (
